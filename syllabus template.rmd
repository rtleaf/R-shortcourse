...
1) Introduce the basics of R programming using real world data sets
...
Learn how to wrangle, analyze and visualize data using base R operations and specialized packages (e.g. tidy verse and ggplot2)
